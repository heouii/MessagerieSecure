...
<div class="blacklist-page">
  <div class="form-wrapper">
    ...
    <form method="POST" action="{{ route('admin.blacklists.store') }}" class="blacklist-form" novalidate>
      @csrf
      ...
      <div class="form-group">
        ...
        <input type="text" name="value" id="value" value="{{ old('value') }}" class="@error('value') invalid @enderror" placeholder="exemple@domaine.com" required>
        @error('value')
          <p class="error-msg">{{ $message }}</p>
        @enderror
      </div>
